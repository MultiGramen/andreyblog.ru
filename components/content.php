<div id="content">
    <div id="posts">
        <div class="post_id">
            ...
            <a class="post_img" href="https://andreyblog.ru:7890/posts/post.php">
            ...
            <div id="post_information">
                <p class="post_information_center">Читать далее</p>
                <p class="post_information_center">Дата публикации поста</p>
                <p class="post_information_center">Рубрика</p>
            </div>
        </div>
        <div class="post_id">
            <p class="post_name">
